...
class DocumentIdentityView extends GetView<DocumentIdentityController> {
  @override
                            ...
                            return DropdownButton(
                              ...
                              items: [
                                DropdownMenuItem(
                                  ...
                                  value: 1,
                                  onTap: () {
                                    _kycController.onChangeIdType(1);
                                  },
                                ),
                                DropdownMenuItem(
                                  ...
                                  value: 2,
                                  onTap: () {
                                    _kycController.onChangeIdType(2);
                                  },
                                ),
                              ],
                              onChanged: (value) {
                                dropDownState(() {
                                  _kycController.valueId = value;
                                });
                              },
                            );
                          },

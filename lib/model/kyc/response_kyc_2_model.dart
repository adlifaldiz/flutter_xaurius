...
//
//     final responseKyc2 = responseKyc2FromJson(jsonString);

import 'dart:convert';

ResponseKyc2 responseKyc2FromJson(String str) => ResponseKyc2.fromJson(json.decode(str));

String responseKyc2ToJson(ResponseKyc2 data) => json.encode(data.toJson());
...
class ResponseKyc2 {
  ...
  factory ResponseKyc2.fromJson(Map<String, dynamic> json) => ResponseKyc2(
